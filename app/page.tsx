...
export default async function HomePage() {
  // 1. Sicherheits-Check auf dem Server
  ...
  const weekLabel = `${start.toLocaleDateString(undefined, opts)} – ${end.toLocaleDateString(undefined, opts)}`;

  return (
    <div className="p-6 min-h-screen bg-slate-950 text-white">
      {/* Oberer Navigationsbalken mit Logout */}
            ...
            return (
              <div
                ...
                className={`rounded p-3 border ${
                  isToday ? "border-amber-500/50 bg-amber-500/10" : "border-white/10 bg-black/10"
                }`}
              >
