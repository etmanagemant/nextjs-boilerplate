...
export function ModelCardSkeleton() {
  return (
    <div className="bg-black/40 p-6 rounded-xl border border-[#AA7C11]/10 animate-pulse">
  ...
  return (
    <div className="space-y-3">
      {[1, 2, 3].map((i) => (
        <div
          key={i}
          className="bg-black/40 p-4 rounded-lg border border-[#AA7C11]/5 animate-pulse"
        >
